...
const activeScholarsData = [
  ...
  { name: 'Jeili Serrata Castro', acum: 3.6, cuat: 3.6, mat: '1-25-2165', uni: 'UTESA', carrera: 'Derecho', padrino: 'Brayan Collado', center: 'Politécnico Canadá', phone: '809-555-3015' },
    ...
    for (const item of activeScholarsData) {
      ...
      await Becario.findOrCreate({
        ...
        defaults: {
          ...
          centro_origen: item.center || 'Liceo / Politécnico Afiliado',
